...
document.querySelector('.btn1').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn1')) {
            var dropdowns = document.getElementsByClassName("btnContent1");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show')) {
...
document.querySelector('.btn2').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn2')) {
            var dropdowns = document.getElementsByClassName("btnContent2");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show')) {
...
document.querySelector('.btn3').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn3')) {
            var dropdowns = document.getElementsByClassName("btnContent3");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show')) {
...
document.querySelector('.btn4').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn4')) {
            var dropdowns = document.getElementsByClassName("btnContent4");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show')) {
...
document.querySelector('.btn5').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn5')) {
            var dropdowns = document.getElementsByClassName("btnContent5");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show')) {
...
document.querySelector('.btn6').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn6')) {
            var dropdowns = document.getElementsByClassName("btnContent6");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show')) {
...
document.querySelector('.btn7').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn7')) {
            var dropdowns = document.getElementsByClassName("btnContent7");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn8').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn8')) {
            var dropdowns = document.getElementsByClassName("btnContent8");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn9').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn9')) {
            var dropdowns = document.getElementsByClassName("btnContent9");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn10').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn10')) {
            var dropdowns = document.getElementsByClassName("btnContent10");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn11').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn11')) {
            var dropdowns = document.getElementsByClassName("btnContent11");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn12').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn12')) {
            var dropdowns = document.getElementsByClassName("btnContent12");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn13').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn13')) {
            var dropdowns = document.getElementsByClassName("btnContent13");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn14').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn14')) {
            var dropdowns = document.getElementsByClassName("btnContent14");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn15').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn15')) {
            var dropdowns = document.getElementsByClassName("btnContent15");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn16').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn16')) {
            var dropdowns = document.getElementsByClassName("btnContent16");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn17').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn17')) {
            var dropdowns = document.getElementsByClassName("btnContent17");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn18').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn18')) {
            var dropdowns = document.getElementsByClassName("btnContent18");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn19').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn19')) {
            var dropdowns = document.getElementsByClassName("btnContent19");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn20').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn20')) {
            var dropdowns = document.getElementsByClassName("btnContent20");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn21').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn21')) {
            var dropdowns = document.getElementsByClassName("btnContent21");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn22').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn22')) {
            var dropdowns = document.getElementsByClassName("btnContent22");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn23').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn23')) {
            var dropdowns = document.getElementsByClassName("btnContent23");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn24').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn24')) {
            var dropdowns = document.getElementsByClassName("btnContent24");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
...
document.querySelector('.btn25').onclick = function () {
    ...
    window.onclick = function (event) {
        if (!event.target.matches('.btn25')) {
            var dropdowns = document.getElementsByClassName("btnContent25");
            var i;
            for (i = 0; i < dropdowns.length; i++) {
                var openDropdown = dropdowns[i];
                if (openDropdown.classList.contains('show1')) {
